        ...
        match op {
            ...
            0xCB => {
                ...
                match op {
                    ...
                    0x40 => self.bit_n_x(0, Register::B),
                    0x41 => self.bit_n_x(0, Register::C),
                    0x42 => self.bit_n_x(0, Register::D),
                    0x43 => self.bit_n_x(0, Register::E),
                    0x44 => self.bit_n_x(0, Register::H),
                    0x45 => self.bit_n_x(0, Register::L),
                    0x46 => unimplemented!(),
                    0x47 => self.bit_n_x(0, Register::A),
                    0x48 => self.bit_n_x(1, Register::B),
                    0x49 => self.bit_n_x(1, Register::C),
                    0x4A => self.bit_n_x(1, Register::D),
                    0x4B => self.bit_n_x(1, Register::E),
                    0x4C => self.bit_n_x(1, Register::H),
                    0x4D => self.bit_n_x(1, Register::L),
                    0x4E => unimplemented!(),
                    0x4F => self.bit_n_x(1, Register::A),
                    0x50 => self.bit_n_x(2, Register::B),
                    0x51 => self.bit_n_x(2, Register::C),
                    0x52 => self.bit_n_x(2, Register::D),
                    0x53 => self.bit_n_x(2, Register::E),
                    0x54 => self.bit_n_x(2, Register::H),
                    0x55 => self.bit_n_x(2, Register::L),
                    0x56 => unimplemented!(),
                    0x57 => self.bit_n_x(2, Register::A),
                    0x58 => self.bit_n_x(3, Register::B),
                    0x59 => self.bit_n_x(3, Register::C),
                    0x5A => self.bit_n_x(3, Register::D),
                    0x5B => self.bit_n_x(3, Register::E),
                    0x5C => self.bit_n_x(3, Register::H),
                    0x5D => self.bit_n_x(3, Register::L),
                    0x5E => unimplemented!(),
                    0x5F => self.bit_n_x(3, Register::A),
                    0x60 => self.bit_n_x(4, Register::B),
                    0x61 => self.bit_n_x(4, Register::C),
                    0x62 => self.bit_n_x(4, Register::D),
                    0x63 => self.bit_n_x(4, Register::E),
                    0x64 => self.bit_n_x(4, Register::H),
                    0x65 => self.bit_n_x(4, Register::L),
                    0x66 => unimplemented!(),
                    0x67 => self.bit_n_x(4, Register::A),
                    0x68 => self.bit_n_x(5, Register::B),
                    0x69 => self.bit_n_x(5, Register::C),
                    0x6A => self.bit_n_x(5, Register::D),
                    0x6B => self.bit_n_x(5, Register::E),
                    0x6C => self.bit_n_x(5, Register::H),
                    0x6D => self.bit_n_x(5, Register::L),
                    0x6E => unimplemented!(),
                    0x6F => self.bit_n_x(5, Register::A),
                    0x70 => self.bit_n_x(6, Register::B),
                    0x71 => self.bit_n_x(6, Register::C),
                    0x72 => self.bit_n_x(6, Register::D),
                    0x73 => self.bit_n_x(6, Register::E),
                    0x74 => self.bit_n_x(6, Register::H),
                    0x75 => self.bit_n_x(6, Register::L),
                    0x76 => unimplemented!(),
                    0x77 => self.bit_n_x(6, Register::A),
                    0x78 => self.bit_n_x(7, Register::B),
                    0x79 => self.bit_n_x(7, Register::C),
                    0x7A => self.bit_n_x(7, Register::D),
                    0x7B => self.bit_n_x(7, Register::E),
                    0x7C => self.bit_n_x(7, Register::H),
                    0x7D => self.bit_n_x(7, Register::L),
                    0x7E => unimplemented!(),
